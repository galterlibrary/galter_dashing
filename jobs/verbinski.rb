...
forecast_location_lat = '41.896572558719'
forecast_location_long = '-87.6199746745882'
...
SCHEDULER.every '15m', :first_in => 0 do |job|
  ...
  send_event('weather_now', { current: current })
  send_event('weather_today', { today: today })
  send_event('weather_week', { upcoming_week: this_week })
end
